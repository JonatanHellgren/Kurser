...
"""
A script that lets one sample pixels from images a bit faster then manually.
Choose which folder to sample in the main function.
"""
...
if __name__ == "__main__":
    ...
    for folder in range(1,12):
        directory = f"./model2_easy_xtra_rel"
